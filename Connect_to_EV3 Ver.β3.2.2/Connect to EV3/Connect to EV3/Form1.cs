...
namespace Connect_to_EV3
{
    public partial class Form1 : Form
    {
        ...
        public void Format()
        {
            string[,] get_value = new string[3,9];
            ...
            if (data.Length>=40)
            {
                ...
                label_mA.Text = get_value[0, 8];
                label_mV.Text = get_value[1, 8];
                ...
                if (((string)comboBox_P1.SelectedItem == "COLOR") && (numericUpDown_P1m.Value == 2))
                {
                    int val = Convert.ToInt32(get_value[0, 0]);
                    switch (val)
                    {
                        case 0:
                ...
                if (((string)comboBox_P2.SelectedItem == "COLOR") && (numericUpDown_P2m.Value == 2))
                {
                    int val = Convert.ToInt32(get_value[0, 1]);
                    switch (val)
                    {
                        case 0:
                ...
                if (((string)comboBox_P3.SelectedItem == "COLOR") && (numericUpDown_P3m.Value == 2))
                {
                    int val = Convert.ToInt32(get_value[0, 2]);
                    switch (val)
                    {
                        case 0:
                ...
                if (((string)comboBox_P4.SelectedItem == "COLOR") && (numericUpDown_P4m.Value == 2))
                {
                    int val = Convert.ToInt32(get_value[0, 3]);
                    switch (val)
                    {
                        case 0:
                ...
                if (((string)comboBox_P1.SelectedItem == "HT COLOR") && (numericUpDown_P1m.Value == 0))
                {
                    int val = Convert.ToInt32(get_value[0, 0]);
                    switch (val)
                    {
                ...
                if (((string)comboBox_P2.SelectedItem == "HT COLOR") && (numericUpDown_P2m.Value == 0))
                {
                    int val = Convert.ToInt32(get_value[0, 1]);
                    switch (val)
                    {
                ...
                if (((string)comboBox_P3.SelectedItem == "HT COLOR") && (numericUpDown_P3m.Value == 0))
                {
                    int val = Convert.ToInt32(get_value[0, 2]);
                    switch (val)
                    {
                ...
                if (((string)comboBox_P4.SelectedItem == "HT COLOR") && (numericUpDown_P4m.Value == 0))
                {
                    int val = Convert.ToInt32(get_value[0, 3]);
                    switch (val)
                    {
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            panel4.BackColor = Color.DeepPink;
                            break;
                        default:
                            panel4.BackColor = Color.White;
                            break;
                ...
                if ((((string)comboBox_P1.SelectedItem == "COLOR") && (numericUpDown_P1m.Value==3)) || (((string)comboBox_P1.SelectedItem == "HT COLOR") && (numericUpDown_P1m.Value == 1)))
                {
                    int R = Convert.ToInt32(get_value[0, 0]);
                    int G = Convert.ToInt32(get_value[1, 0]);
                    int B = Convert.ToInt32(get_value[2, 0]);
                ...
                if ((((string)comboBox_P2.SelectedItem == "COLOR") && (numericUpDown_P2m.Value == 3)) || (((string)comboBox_P2.SelectedItem == "HT COLOR") && (numericUpDown_P2m.Value == 1)))
                {
                    int R = Convert.ToInt32(get_value[0, 1]);
                    int G = Convert.ToInt32(get_value[1, 1]);
                    int B = Convert.ToInt32(get_value[2, 1]);
                    if ((R > 0) && (R < 256) && (G > 0) && (G < 256) && (B > 0) && (B < 256))
                    {
                        Color color = Color.FromArgb(R, G, B);
                ...
                if ((((string)comboBox_P3.SelectedItem == "COLOR") && (numericUpDown_P3m.Value == 3)) || (((string)comboBox_P3.SelectedItem == "HT COLOR") && (numericUpDown_P3m.Value == 1)))
                {
                    int R = Convert.ToInt32(get_value[0, 2]);
                    int G = Convert.ToInt32(get_value[1, 2]);
                    int B = Convert.ToInt32(get_value[2, 2]);
                    if ((R > 0) && (R < 256) && (G > 0) && (G < 256) && (B > 0) && (B < 256))
                    {
                        Color color = Color.FromArgb(R, G, B);
                ...
                if ((((string)comboBox_P4.SelectedItem == "COLOR") && (numericUpDown_P4m.Value == 3)) || (((string)comboBox_P4.SelectedItem == "HT COLOR") && (numericUpDown_P4m.Value == 1)))
                {
                    int R = Convert.ToInt32(get_value[0, 3]);
                    int G = Convert.ToInt32(get_value[1, 3]);
                    int B = Convert.ToInt32(get_value[2, 3]);
                    if ((R > 0) && (R < 256) && (G > 0) && (G < 256) && (B > 0) && (B < 256))
                    {
                        Color color = Color.FromArgb(R, G, B);
